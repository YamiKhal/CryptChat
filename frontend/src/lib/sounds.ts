...
export function configureCustomSounds(
    ...
    for (const key of Object.keys(customUrls) as SoundEvent[])
...
function pattern(
    event: Exclude<SoundEvent, "call-incoming" | "call-outgoing">,
): ToneSpec[] {
    switch (event) {
        case "message-in":
        ...
        case "message-sent":
            ...
            return [
                { freq: 980, duration: 0.08, gain: 0.22, type: "triangle" },
            ];
        case "typing":
