import { buildBackup, restoreBackup, isBackupContainer, BackupContainer } from '@/lib/backup/container';
...
export async function downloadBackup(userId: string, username: string): Promise<boolean> {
