        ...
        <div className="modal-backdrop" onClick={onClose}>
            ...
            >
                <div className="flex items-center gap-3">
                    <div className="bg-error-soft text-error grid h-10 w-10 flex-none place-items-center rounded-full">
                        <LogOut size={18} />
                    </div>
                    <div className="min-w-0">
                        ...
                        <p className="t-base text-muted">
                            You'll sign back in with your password.
                        </p>
                    </div>
                </div>

                <p className="t-base text-muted">
                    Your keys stay on this device. logging out does not erase
                    them. To wipe this identity entirely, use the danger zone
                    instead.
                </p>
