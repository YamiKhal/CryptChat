    ...
    return (
        <>
            ...
            {open &&
                createPortal(
                    <div
                        className="animate-fade-in fixed inset-0 z-[60] flex items-center justify-center bg-black p-4 motion-reduce:animate-none sm:p-8"
                    ...
                    >
                        ...
                        <button
                            type="button"
                            onClick={() => setOpen(false)}
                            className="absolute top-4 right-4 grid h-9 w-9 place-items-center rounded-full bg-zinc-800 text-white transition-colors hover:bg-zinc-700"
                            aria-label="Close"
                        >
                            <X size={18} />
                        </button>
