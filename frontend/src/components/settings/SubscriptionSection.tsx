        ...
        <>
          ...
          the mechanic is never invisible. --- */}
            ...
            >
                <SettingBlock>
                    {badge ? (
                        <p className="t-base flex items-center gap-2">
                            <Badge since={badge.since} size="md" withLabel />
                            <span className="text-muted">
                                since{" "}
                                {new Date(badge.since).toLocaleDateString()}
                            </span>
                        </p>
                    ) : (
                        ...
                        (portalUrl ? (
                            <>
                                <a
                                    ...
                                    className="btn-ghost t-base block w-full text-center"
                                >
                                ...
                                <p className="t-small text-muted">
                                    ...
                                    enter the email you paid with and they will
                                    send you a link. We cannot do it for you: we
                            ...
                            <InfoBox variant="warn">
                                Cancellation is not configured on this
                                deployment. Contact support to cancel.
                            </InfoBox>
                        ))}
                </SettingBlock>
            </SettingsSection>
