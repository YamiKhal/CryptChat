        ...
        <div className="grid min-h-screen place-items-center p-4">
            <div className="w-full max-w-sm space-y-4 py-8">
                <header className="space-y-1 text-center">
                    <h1 className="t-h1 text-primary flex items-center justify-center gap-2 font-bold tracking-tight">
                        <Crown
                            size={22}
                            className="fill-warn-soft text-warn"
                            aria-hidden="true"
                        />
                        Supporter
                    </h1>
                ...
                <section className="card space-y-3">
                    <h2 className="t-base text-muted tracking-wider uppercase">
                        how this works
                    </h2>
                    <ol className="t-small text-muted space-y-2">
                        <li>
                            <span className="text-foreground">1.</span> You pay
                            without logging in. We never send your account to
                            Stripe. we do not send one, because you are not
                            logged in.
                        </li>
                        <li>
                            <span className="text-foreground">2.</span> You get
                            a redemption code by email.
                        </li>
                        <li>
                            <span className="text-foreground">3.</span> You (or
                            whoever you gift it to) enter the code in Settings.
                            That is what turns the badge on.
                        </li>
                    </ol>
                    <InfoBox>
                        We store no payment details and our database holds no
                        link between your payment and your account. only that{" "}
                        <em>some</em> account redeemed <em>some</em> code.
                        Stripe still knows who paid, as your card issuer does;
                        anyone with access to both sides could match them up. We
                ...
                <Link
                    to="/login"
                    className="t-base text-muted hover:text-foreground block text-center"
                >
                    back
                </Link>
            </div>
                ...
                <div className="card space-y-4 text-center">
                    {state === "waiting" && (
                        <>
                            ...
                            <p className="t-small text-muted">
                                This can take a few seconds. Your payment
                                already went through. do not pay again.
                            </p>
                        </>
                    )}
                    ...
                    {state === "ready" && (
                        <>
                            <Crown
                                size={24}
                                className="fill-warn-soft text-warn mx-auto"
                                aria-hidden="true"
                            />
                            <p className="t-h4">
                            ...
                            <InfoBox className="text-left">
                                Your code has been emailed to you. Enter it
                                under{" "}
                                <span className="font-medium">
                                    Settings → Subscription
                                </span>
                                . or pass it on, if it was a gift.
                            </InfoBox>
                            <p className="t-small text-muted">
                                We store only a hash of the code, so nobody.
                                including us. can look it up or re-send it. Keep
                                the email until it has been redeemed.
                            </p>
                        </>
                    )}
                    ...
                    {state === "error" && (
                        <>
                            ...
                            <p className="t-small text-muted">
                                If you were charged, your code is on its way by
                                email regardless. the payment and this page are
                                independent.
                            </p>
                        </>
                    )}
