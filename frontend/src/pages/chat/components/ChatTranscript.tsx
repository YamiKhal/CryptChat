        ...
        <div className="relative min-h-0 flex-1">
          ...
          scroll layer below. */}
            ...
            <div
                ...
                data-chat-bubbles={
                    vault.preferences.hideMessageBubbles ? "hidden" : undefined
                }
                className="absolute inset-0 space-y-1 overflow-x-hidden overflow-y-auto bg-cover bg-center p-4"
                style={
            ...
            >
                {loading && (
                    <p className="t-base text-muted text-center">decrypting…</p>
                )}

                {!loading && messages.length === 0 && channel.hasKey && (
                    <p className="t-base text-muted text-center">
                        No messages yet.
                    </p>
                )}
                    ...
                    return items.flatMap((item, i) => {
                        ...
                        if (day !== prevDay) {
                            ...
                            nodes.push(
                                ...
                                >
                                    ...
                                    <span className="bg-surface-raised t-small text-muted rounded-full px-3 py-1 font-medium">
                                        {dayLabel(item.at)}
                                    </span>
                                    <span className="bg-border h-px flex-1" />
                                </div>,
                        ...
                        if (item.type === "presence") {
                            ...
                            nodes.push(
                                ...
                                >
                                    <span className="bg-surface-raised t-small text-muted rounded-full px-3 py-1">
                                        {item.text}
                                    </span>
                                </div>,
                            );
                        ...
                        const nextGroups =
                            ...
                            new Date(next.message.createdAt).getTime() -
                                new Date(message.createdAt).getTime() <
                                GROUP_GAP_MS;
                        ...
                        nodes.push(
                            <MessageRow
                                ...
                                senderTrusted={
                                    !channel.incognito &&
                                    isVerified(message.senderId)
                                }
                                leftAligned={
                                    vault.preferences.messagesLeftAligned
                                }
                                hideAvatars={
                                    vault.preferences.hideProfileImages
                                }
