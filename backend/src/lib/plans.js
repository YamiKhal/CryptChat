...
export const PLANS = {
  ...
  gift1: { kind: 'gift', months: 1, label: '1 month', blurb: 'one-off', priceKey: 'gift1' },
  gift3: { kind: 'gift', months: 3, label: '3 months', blurb: 'one-off', priceKey: 'gift3' },
  gift6: { kind: 'gift', months: 6, label: '6 months', blurb: 'one-off', priceKey: 'gift6' },
  gift12: { kind: 'gift', months: 12, label: '12 months', blurb: 'one-off', priceKey: 'gift12' },
};
...
export function availablePlans() {
  return Object.keys(PLANS)
    ...
    .filter(Boolean)
    .map(({ slug, kind, months, label, blurb }) => ({ slug, kind, months, label, blurb }));
}
